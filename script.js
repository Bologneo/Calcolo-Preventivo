...
function calcolaPreventivo() {
  ...
  document.getElementById('totale-netto').textContent = `€ ${totale * 0.35}`;
  document.getElementById('rata50').textContent = `€ ${(totale * 0.5) / 36}`;
  document.getElementById('rata35').textContent = `€ ${(totale * 0.35) / 24}`;
